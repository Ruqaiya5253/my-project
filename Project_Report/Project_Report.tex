...
\begin{document}
	...
	\href{https://github.com/Ruqaiya5253/my-project}{Github - https://github.com/Ruqaiya5253/my-project} }
	\date{\today}
	...
	Note : Later on we added a more getters for gyro.x gyro.y and gyro.z, same with accel.x accel.y and accel.z, and the tilt angles to we can print it via uart and then show them working on a graph.
	
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\textwidth]{Figure_1.png}
		\caption{Gyro and Accelerator Sensor Data}
